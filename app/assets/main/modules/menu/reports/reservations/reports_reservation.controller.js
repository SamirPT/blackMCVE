/**
 * Created by EGusev on 11.07.2016.
 */
(function () {
    'use strict';

    angular.module('mrblack.main').controller('ReportsReservationCtrl', ['$scope', 'ReportsService', '$state', 'Toastr', 'VenueService', 'UtilService', function ($scope, ReportsService, $state, Toastr, VenueService, UtilService) {
        ...
        $scope.getReportPDF = function (dateFrom, dateTo, reportType) {
            ...
            ReportsService.getReservationsReportPDF({dateFrom: dateFrom, dateTo: dateTo, venueId: $state.params.id, reportType: reportType}).then(
        ...
        $scope.getReport = function(dateFrom, dateTo, reportType) {
            ...
            ReportsService.getReservationsReport({dateFrom: dateFrom, dateTo: dateTo, venueId: $state.params.id, reportType: reportType}).then(
